      ...
      <div className="grid gap-12 lg:grid-cols-[1.1fr,0.9fr] lg:items-start">
        ...
        <div>
          ...
          <p className="mt-6 text-sm leading-relaxed text-[#5d4a3c]">
            ...
            True wellness requires commitment, consistency, courage, and desire
            — and while the journey isn&apos;t always easy, the transformation
            that follows is deeply meaningful.
          </p>

          <p className="mt-4 text-sm leading-relaxed text-[#5d4a3c]">
            With a 25-year foundation in healthcare, my practice is built on the
            understanding that each person has the ability to take control of
            their health and well-being. Often, all someone needs is the right
            support, perspective, and guidance to begin.
          </p>

          <p className="mt-4 text-sm leading-relaxed text-[#5d4a3c]">
            I approach wellness from a mind-body-spirit perspective, honoring
            the truth that everything in a person&apos;s life is connected —
            mental health, physical health, emotions, stress, habits,
            relationships, and how we speak to ourselves.{" "}
            <span className="font-medium">
        ...
        <aside className="rounded-3xl border border-[#e5d5c9] bg-[#fff9f4] p-6 shadow-sm">
          ...
          <p className="mt-4 text-sm italic leading-relaxed text-[#7a6250]">
            “My goal is to create a safe, supportive space where clients feel
            seen, understood, and empowered to reach their goals — one
          ...
          <p className="mt-4 text-[11px] leading-relaxed text-[#5d4a3c]">
            ...
            connected, and every person deserves to feel their best — from the
            inside out.
          </p>
...
/** Small helper component for the icon pills */
